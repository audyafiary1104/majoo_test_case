                        ...
                        <div class="upload_an_items p-4">
                            ...
                            <form action="{{route('update.product',['id' => $product->id])}}" method="post" enctype='multipart/form-data'>
                                ...
                                <div class="form-group  animate__animated animate__fadeInUp wow">
                                    ...
                                    <div class="select_box w-100 d-flex ">
                                        <select class="tokenizer" name="category">
                                            ...
                                            <option value="{{$cat->id}}" {{($product->id_product_category == $cat->id ? 'selected' : '')}}>{{$cat->name}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group  animate__animated animate__fadeInUp wow">
                                    ...
                                    <textarea rows="5" class="form-control py-1 ckeditor" value="{{$product->description}}" name="description"></textarea>
                                </div>
