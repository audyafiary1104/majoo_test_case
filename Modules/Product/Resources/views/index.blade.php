        ...
        <div class="row align-items-center mx-0">
            <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 p-0">
                <div class="title_inner d-flex">
                    <h1 class="d-flex align-items-center">Product
                    </h1>
                    <button type="button" class="btn"><a href="{{route('create.product')}}">Add New</a></button>
                </div>
            </div>
                ...
                <div class="order_list">
                    ...
                    <ul>
                        ...
                        <li class="d-flex animate__animated animate__fadeInUp wow">
                            ...
                            <h3 class="text-center Amount Category">{{$pr->category}}</h3>
                            <h3 class="text-center Table Price">${{$pr->price}}</h3>
                            <div class="btn_container d-flex mr-0">
                    
                                <button type="button" class="btn">
                                    <a href="{{route('edit.product',['id'=>$pr->id])}}"><i class="zmdi zmdi-edit"></i></a>
                                </button>
                                <button type="button" class="btn">
                                    <a href="{{route('destroy.product',['id'=>$pr->id])}}"><i class="zmdi zmdi-delete"></i></a>
                                </button>
