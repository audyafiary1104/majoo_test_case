        ...
        <div class="row align-items-center mx-0">
            <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 p-0">
                <div class="title_inner d-flex">
                    <h1 class="d-flex align-items-center">Category
            ...
            <div>
                ...
                <div class="order_list">
                    <div class="list_header d-flex">
                        <h2 class="text-left Name">Category</h2>

                        <h2 class="text-right">Action</h2>
                    </div>

                    <ul>
                    @foreach($category as $cat)
                        <li class="d-flex  animate__animated animate__fadeInUp wow">
                            <h3 class="text-left Name"><strong>{{$cat->name}}</strong></h3>
                            <div class="btn_container Action d-flex ">
                            @can('delete_category')

                                <button type="button" class="btn " >
                                    <a href="{{route('delete.category',['id' => $cat->id])}}"><i class="zmdi zmdi-delete"></i></a>
                                </button>
                                @endcan
                                @can('edit_category')
                                <button type="button" class="btn edit" data-url="{{route('update.category',['id' => $cat->id])}}">
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header px-0">
                <h2 class="col-11 mx-auto">Add Category</h2>
            </div>
            <div class="modal-body p-0">
                <form class="pt-2 pt-sm-2 pt-md-4" method="post" action="{{route('store.category')}}">
                @csrf    
...
<div class="modal fade add_category_model add_expenses receipt_model px-0" id="edit_people" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header px-0">
                <h2 class="col-11 mx-auto">Edit Category</h2>
            </div>
            <div class="modal-body p-0">
                <form class="pt-2 pt-sm-2 pt-md-4" id="update_cat" method="post" action="">
                @csrf    
                <div class="col-11 mx-auto form_container">
                        <div class="form-group animate__animated animate__fadeInUp wow" data-wow-duration=".5s">
                            <label>Category Name</label>
