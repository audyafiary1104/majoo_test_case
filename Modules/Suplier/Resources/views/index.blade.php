@extends('suplier::layouts.master')
            ...
            <div class="row align-items-center mx-0">
                <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 p-0">
                    <div class="title_inner d-flex">
                        <h1 class="d-flex align-items-center">Suplier
                    ...
                    <div class="order_list">
                        ...
                        <ul>
                            ...
                            <li class="d-flex  animate__animated animate__fadeInUp wow">
                                ...
                                <h3 class="text-left Name"><strong>{{$sup->name}}</strong></h3>
                                <h3 class="text-left email">{{$sup->email}}</h3>
                                <div class="btn_container d-flex mr-0 ">
                                    <button type="button" class="btn">
                                        <a href="{{route('destroy.suplier',['id' => $sup->id])}}"><i class="zmdi zmdi-delete"></i></a>
                                    </button>
                                    <button type="button" class="btn edit" data-url="{{route('update.suplier',['id' => $sup->id])}}">
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header px-0">
                    <h2 class="col-11 mx-auto">Add Suplier</h2>
                </div>
                <div class="modal-body p-0">
                    <form class="pt-2 pt-sm-2 pt-md-4" method="post" action="{{route('suplier.store')}}">
                    @csrf    
...
<div class="modal fade add_category_model add_expenses receipt_model px-0" id="edit_people" tabindex="-1" role="dialog" aria-labelledby="receipt_modelTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header px-0">
                    <h2 class="col-11 mx-auto">Edit Suplier</h2>
                </div>
                <div class="modal-body p-0">
